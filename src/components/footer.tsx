            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center mb-12">
                    <div className="flex space-x-6 text-xs font-bold uppercase tracking-wider text-text-muted-light dark:text-text-muted-dark mb-6 md:mb-0">
                        <a className="hover:text-primary dark:hover:text-white transition-colors" href="#">Dribbble</a>
                        <a className="hover:text-primary dark:hover:text-white transition-colors" href="#">Behance</a>
                        <a className="hover:text-primary dark:hover:text-white transition-colors" href="#">LinkedIn</a>
                ...
                <div className="bg-primary dark:bg-black text-white text-center py-4 rounded-full text-xs font-medium opacity-90">
                    &copy; 2025 Code with Risqi. Hak cipta dilindungi undang-undang.
                </div>
            </div>
        </footer>
    );
